...
class PixelPainter extends CustomPainter {
  ...
  static Expanded sendButton(var page, var sockEvent, bool sockEventState, String displayText, HSVColor color_text) {
    return Expanded(child:
      ElevatedButton(onPressed: sockEventState? () {
        if (displayText.isEmpty) {
          ...
          // send color and then text data:

          String color_val = "DSTC";
          color_val += intToString(color_text.toColor().red);
          color_val += intToString(color_text.toColor().green);
          color_val += intToString(color_text.toColor().blue);
          sockEvent.write(color_val + "k");
  ...
  static Row saveDisplayWidgets(var page) {
    return Row(children: [
      ElevatedButton(
        ...
        ElevatedButton(
          child: Text("M" + numberFile.toString()),
          onPressed: (){
            numberFile++;
...
class DisplayTools {
  ...
  static TextEditingController displayTextCont = TextEditingController();

  static Row textField() {
    return Row(children: [
      SizedBox(width: 200, height: 50,
        child: TextFormField(
          controller: displayTextCont,
          maxLength: 30,
